...
function setTrust (ip, address, shareValidated, isIPC) {
  ...
  if (shareTrustIP && shareTrustAddress) {
    if (shareValidated) {
      ...
      } else if (dateNowSeconds - shareTrustIP.ipcRateBeginSeconds > shareTrustConfig.maxIPCRate && dateNowSeconds - shareTrustAddress.ipcRateBeginSeconds > shareTrustConfig.maxIPCRate) {
        shareTrustIP.ipcRateBeginSeconds = shareTrustAddress.ipcRateBeginSeconds = dateNowSeconds
