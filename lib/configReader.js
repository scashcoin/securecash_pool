...
var configFile = (function () {
  for (var i = 0; i < process.argv.length; i++) {
    if (process.argv[i].indexOf('-config=') === 0) { return process.argv[i].split('=')[1] }
  }
  return 'config.json'
})()
...
var donationAddresses = {
  devDonation: {
    SCSX: 'SdjoXXo3hc2VhTkfeEKhXifTFsJ7EUBMmD33qDLRRGNSEvfxBJNohoah1rRaCtkotY2UQ6d6ymyQcKqvBunfr3RE1nDKwCrZQ'
  },
  coreDevDonation: {
