...
var cryptoNight = multiHashing['cryptonight-lite']
var cryptoNightLite = multiHashing['cryptonight-lite']
var cryptoNightTurtleLite = multiHashing['cryptonight-lite']
var chukwa = multiHashing['cryptonight-lite']
...
function processShare (miner, job, blockTemplate, nonce, resultHash) {
  ...
  if (shareTrust.enabled && shareTrust.checkTrust(miner.ip, miner.login, job.difficulty)) {
    ...
    if (shareBuffer[0] >= 6) {
      hash = cryptoNightLite(convertedBlob)
